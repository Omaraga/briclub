        ...
        <?= dmstr\widgets\Menu::widget(
            [
                ...
                'items' => [
                    ...
                    ['label' => 'Матрица', 'icon' => 'dashboard', 'url' => ['/matrix'], 'visible' => User::isAccess('admin')],
                    ...
                    ['label' => 'Представители', 'icon' => 'dashboard', 'url' => ['/agent'], 'visible' => User::isAccess('admin')],
...
//                    ['label' => 'Пополнение токенов', 'icon' => 'file-code-o', 'url' => ['/deposit-tokens'], 'visible' => User::isAccess('admin')],
					...
					['label' => 'Отзывы курсов', 'icon' => 'file-code-o', 'url' => ['/course-reviews'], 'visible' => User::isAccess('admin')],
