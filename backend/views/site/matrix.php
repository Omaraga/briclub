...
<div class="site-index">
        ...
        <div>
            ...
            <? foreach ($matrix as $mat) {?>
                <div style="margin-left: 140px;" class="col-lg-12 first-block"><?=\common\models\User::findOne($mat['user_id'])['username']?> w: <?=\common\models\User::findOne($mat['user_id'])['w_balans']?> </div>
                <?
                    $children1 = null;$children2 = null;$children3 = null;
                    if($mat['children']>0){
                        $children1 = \common\models\UserPlatforms::find()->where(['parent_id'=>$mat['id'],'deleted'=>2])->all();
                    }

                ?>
                <div class="row">
                <?if(isset($children1[0])){?>
                    <div style="margin-left: 60px;width: 180px;float: left;" class="col-lg-12 second-block1"><?=\common\models\User::findOne($children1[0]['user_id'])['username']?> w: <?=\common\models\User::findOne($children1[0]['user_id'])['w_balans']?></div>
                <?}?>

                <?if(isset($children1[1])){?>
                    <div style="margin-left: 20px;" class="col-lg-12 second-block2"><?=\common\models\User::findOne($children1[1]['user_id'])['username']?> w: <?=\common\models\User::findOne($children1[1]['user_id'])['w_balans']?></div>
                <?}?>
                </div>
                <div class="row">
                    <hr>
    ...
    <div>
        ...
        <div class="row">
            ...
            <?if(isset($children1[1])){?>
                <div style="margin-left: 20px;width: 200px;" class="col-lg-12 second-block2"><?=\common\models\User::findOne($children1[1]['user_id'])['username']?> w: <?=\common\models\User::findOne($children1[1]['user_id'])['w_balans']?></div>
            <?}?>
        </div>
            <?
            ...
            <div class="row">
                ...
                <?if(isset($children2[0])){?>
                    <div style="margin-left: 0px;width: 110px;" class="col-lg-12 third-block"><?=\common\models\User::findOne($children2[0]['user_id'])['username']?> w: <?=\common\models\User::findOne($children2[0]['user_id'])['w_balans']?> </div>
                <?}?>
                <?if(isset($children2[1])){?>
                    <div style="margin-left: 0px;width: 110px;" class="col-lg-12 third-block"><?=\common\models\User::findOne($children2[1]['user_id'])['username']?> w: <?=\common\models\User::findOne($children2[1]['user_id'])['w_balans']?> </div>
                <?}?>

                <?if(isset($children3[0])){?>
                    <div style="margin-left: 0px;width: 110px;" class="col-lg-12 third-block"><?=\common\models\User::findOne($children3[0]['user_id'])['username']?>w: <?=\common\models\User::findOne($children3[0]['user_id'])['w_balans']?> </div>
                <?}?>
                <?if(isset($children3[1])){?>
                    <div style="margin-left: 0px;width: 110px;" class="col-lg-12 third-block"><?=\common\models\User::findOne($children3[1]['user_id'])['username']?> w: <?=\common\models\User::findOne($children3[1]['user_id'])['w_balans']?> </div>
                <?}?>
            </div>
            <div class="row">
                <hr>
