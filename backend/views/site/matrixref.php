...
<div class="site-index">
    ...
    <div>
        ...
        <? foreach ($matrix1 as $mat) {?>
            ...
            if($mat['children']>0){
                $children1 = \common\models\MatrixRef::find()->where(['parent_id'=>$mat['id']])->all();
            }
            ...
            if(isset($children1[0]['children']) and $children1[0]['children']>0){
                $children2 = \common\models\MatrixRef::find()->where(['parent_id'=>$children1[0]['id']])->all();
            }
            if(isset($children1[1]['children']) and $children1[1]['children']>0){
                $children3 = \common\models\MatrixRef::find()->where(['parent_id'=>$children1[1]['id']])->all();
            }
    ...
    <div>
        ...
        <? foreach ($matrix2 as $mat) {?>
            ...
            <div class="row">
                ...
                <div style="margin-left: 60px;width: 180px;float: left;" class="col-lg-12 second-block1"><?=\common\models\User::findOne($children1[0]['user_id'])['username']?>
                    <?if(isset($children1[0])){?>
                        <?
                        $matr = $children1[0];
                        if($matr['reinvest'] == 1){
            ...
            <div class="row">
                ...
                <?if(isset($children2[1])){?>
                    <div style="margin-left: 0px;width: 110px;" class="col-lg-12 third-block">
                        ...
                        ?>
                        w: <?=\common\models\User::findOne($children2[1]['user_id'])['w_balans']?> </div>
                <?}?>
                ...
                <?if(isset($children3[0])){?>
                    <div style="margin-left: 0px;width: 110px;" class="col-lg-12 third-block">
                        ...
                        ?>
                        w: <?=\common\models\User::findOne($children3[0]['user_id'])['w_balans']?> </div>
                <?}?>
                <?if(isset($children3[1])){?>
                    <div style="margin-left: 0px;width: 110px;" class="col-lg-12 third-block">
                        <?=\common\models\User::findOne($children3[1]['user_id'])['username']?>
                        ...
                        ?>
                        w: <?=\common\models\User::findOne($children3[1]['user_id'])['w_balans']?> </div>
                <?}?>
            </div>
            <div class="row">
                <hr>
            ...
            <div class="row">
                <?if(isset($children1[0])){?>
                    <div style="margin-left: 60px;width: 180px;float: left;" class="col-lg-12 second-block1"><?=\common\models\User::findOne($children1[0]['user_id'])['username']?>
                        ...
                        ?>
                        w: <?=\common\models\User::findOne($children1[0]['user_id'])['w_balans']?> </div>
                <?}?>
