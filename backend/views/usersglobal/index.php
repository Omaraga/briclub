...
<div class="site-index">
    <div class="row">
        <div class="col-12">
            ...
            <div class="row">
                <div class="col-3">
                    <form id="w0" action="/usersglobal" method="get">
            ...
            <form id="w0" action="/usersglobal" method="get">
                ...
                <div class="form-group field-activities-username">
                    ...
                    <select name="platform" id="platform_id" class="form-control">
                        ...
                        <option value="1" <?if($platform == 1){?>selected<?}?>>Глобальный поток</option>
                        <option value="2" <?if($platform == 2){?>selected<?}?>>Уровень 1</option>
                        <option value="3" <?if($platform == 3){?>selected<?}?>>Уровень 2</option>
                        <option value="4" <?if($platform == 4){?>selected<?}?>>Уровень 3</option>
                        <option value="5" <?if($platform == 5){?>selected<?}?>>Уровень 4</option>
                        <option value="6" <?if($platform == 6){?>selected<?}?>>Уровень 5</option>
                        <option value="7" <?if($platform == 7){?>selected<?}?>>Уровень 6</option>
                        <option value="8" <?if($platform == 8){?>selected<?}?>>Уровень 7</option>
                    </select>
                    <div class="help-block"><?=$error?></div>
                </div>
                <div class="form-group">
