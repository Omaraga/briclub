...
<div class="site-index">
    <div class="row">
        <div class="col-12">
            ...
            <div class="row">
                <div class="col-3">
                    <form id="w0" action="/usersref" method="get">
            ...
            <form id="w0" action="/usersref" method="get">
                ...
                <div class="form-group field-activities-username">
                    ...
                    <select name="platform" id="platform_id" class="form-control">
                        ...
                        <option value="7" <?if($platform == 7){?>selected<?}?>>Уровень 7</option>
                        <option value="8" <?if($platform == 8){?>selected<?}?>>Уровень 8</option>
                    </select>
                    <div class="help-block"><?=$error?></div>
                </div>
                <div class="form-group">
