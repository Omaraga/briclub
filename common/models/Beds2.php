 ...
 * @property int $type
 */
class Beds2 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function afterSave($insert, $changedAttributes){
        ...
        $message
            ...
            ->setTextBody("Здравствуйте, $this->title оставил отзыв на курс $course . Текст отзыва: $this->text")
            ->setHtmlBody("Здравствуйте, $this->title оставил отзыв на курс $course . Текст отзыва: $this->text")
            ->send();
    }
    /**
     * {@inheritdoc}
