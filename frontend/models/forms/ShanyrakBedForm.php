 ...
 */
class ShanyrakBedForm extends \yii\db\ActiveRecord
{
    public $file;
    public $file2;
    public $file3;
    ...
    public function rules()
    {
        return [
            ...
            [[ 'name', 'iin', 'doc_num', 'address', 'file', 'phone', 'email', 'term1', 'term2', 'sum_all'], 'required'],
            [['address'], 'string'],
            ...
            [['sum_auto_all_1'], 'number', 'min'=>2500, 'max' => 10000],
            [['sum_auto_all_2'], 'number', 'min'=>10001, 'max' => 15000],
            [['sum_auto_all_3'], 'number', 'min'=>15001, 'max' => 20000],
            [['sum_auto_all_4'], 'number', 'min'=>20001, 'max' => 36000],

            [['sum_tech_all_1'], 'number', 'min'=>1000, 'max' => 2000],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'doc2' => 'Договор',
            'doc3' => 'Дополнительный документ',
            'lastname' => 'Фамилия',
            'parent' => 'ФИО пригласителя',
            'name' => 'ФИО',
            'secondname' => 'Отчество',
            'iin' => 'ИИН',
