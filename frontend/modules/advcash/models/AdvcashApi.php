...
class AdvcashApi extends Model
{
    ...
    /**
     * Получение данных для авторизаций
     * Если они хранятся гдето в базе, здесь нужно вызывать метод которые будет получать
     * Либо можно просто вручную здесь указать
     */
    public function getAccountData()
    {
        $this->accountEmail = 'vostok779955@gmail.com';
        $this->password = 'zxcmnb225577am';
        $this->name = 'BestRoadInvest';
    }

    /**
      * Подключение к системе Advcash
      */
    public function registerClient()
    {
        if ($this->accountEmail == null || $this->password == null) return false;
        try {
    ...
    /**
     * Проверка на существование аккаунта в Advcash
     * @param $email
     * @param $walletId
     * @param $firstName
     * @param $lastName
    ...
    /**
     * Метод для вызова функций API Advcash
     * @param $method
     * @param $params
     * @return \stdClass
     * @throws \SoapFault
