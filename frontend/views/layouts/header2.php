...
<style>
    ...
    .loader li:nth-child(1) {
        animation: li-1 1s ease-in-out infinite;
    }
    .loader li:nth-child(2) {
        animation: li-2 1s ease-in-out infinite;
    }
    .loader li:nth-child(3) {
        animation: li-3 1s ease-in-out infinite;
    }
    @keyframes li-1 {
...
<div class="loader center-loader">
    ...
    <div>
        ...
        <h5 class="w5">Идет загрузка</h5>
    </div>
</div>
<header class="header" style="">
<!--    --><?//if($showBanner):?>
<!--        <div class="dop-panel">-->
<!--            <div class="header-panel" style="height: 50px;">-->
<!--                <div class="header-premium-btn">-->
<!--                    <img src="/img/coron-gold.svg" alt="">-->
<!--                    <p class="w5 ml-2" style="color: #000; font-size: 13px;">Premium аккаунт</p>-->
<!--                </div>-->
<!--                <div class="text-group-heder" style="display: flex; width: 50%;">-->
<!--                    <p class="text-otp" style="width:270px;">Получите <span style="color:#E8FF00; margin-left: 8px;">на год за 100 CV <br>навсегда за 150 CV</span></p>-->
<!--                    <p>Осталось: <span style="color:#E8FF00; margin-left: 8px;"> --><?//=$day;?><!-- д --><?//=$hour;?><!-- ч</span></p>-->
<!--                </div>-->
<!--                <div style="width: 25%; display: flex; justify-content: space-between;">-->
<!--                    <a href="/premium" class="btn btn-default btn__blue" style="color:#fff">Приобрести Premium</a>-->
<!--                    <button type="button" class="btn-close btn-close-white btn text-white" id="closeBanner"  aria-label="Close">X</button>-->
<!--                </div>-->
<!--            </div>-->
<!--        </div>-->
<!--    --><?//endif;?>
    ...
    <nav class="navbar navbar-expand-lg" style="border: none">
        <div class="container">
            ...
            <div class="sidebar" style="transition: 0.3s; z-index: 3">
                <ul class="nav__list">
                    ...
                    <nav class="nav__body">
                        <ul class="nav__list">
                            ...
                            <?if($activ){?>
                                <li class="nav__list-item">
                                    <a href="/courses" class="<?=(Yii::$app->requestedRoute=='courses')?'active':'';?>">
            ...
            <div class="main__block">
                ...
                <div class="top__bar">
                    ...
                    <div class="navbar-container">
                        <header class="<?=($showBanner)?'header-obs':''?>">
                            <div class="bab">
                                <div id="ytWidgetDesk">
