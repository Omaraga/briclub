...
$proms = \common\models\PromotionRef::find()->orderBy('id desc')->all();
?>

    <main class="bonus-history">
        <div class="container">
            <div class="hgroup">
                <h1 class="h1">Еженедельная бонусная программа</h1>
                <div class="hline"></div>
            </div>
            <div class="accordion style3" id="accordionExample">
                ...
                foreach ($proms as $prom) {
                    ...
                    $shoulder1_text = $user_pr['shoulder1'];
                    $shoulder2_text = $user_pr['shoulder2'];
                    if(!empty($user_pr)){
                        $profit = $user_pr['sum'];
                        if(!empty($user_pr['shoulder_next'])){
                            if($user_pr['shoulder_next'] == 1){
                                $shoulder1_text = ($user_pr['shoulder1'])."<br>На этой неделе: ".($user_pr['shoulder1'] - $user_pr['res_next'])."<br>С прошлой недели: + ".$user_pr['res_next'];
                                $shoulder2_text = ($user_pr['shoulder2'])."<br><br><br>";
                            }elseif($user_pr['shoulder_next'] == 2){
                                $shoulder2_text = ($user_pr['shoulder2'])."<br>На этой неделе: ".($user_pr['shoulder2'] - $user_pr['res_next'])."<br>С прошлой недели + ".$user_pr['res_next'];
                                $shoulder1_text = ($user_pr['shoulder1'])."<br><br><br>";
                            }
                        }
                    }
                    ?>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <section class="wrap card-user lvl1">
                                                <small class="lead">Левое плечо: <?=$shoulder1_text?></small>
                                                <?
                                                $i1 = 0;
                                        ...
                                        <div class="col-lg-6">
                                            <section class="wrap card-user lvl1">
                                                <small class="lead">Правое плечо: <?=$shoulder2_text?></small>
                                                <?
                                                $i2 = 0;
