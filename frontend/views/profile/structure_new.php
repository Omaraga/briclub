...
function getModalContent($obj, $dropDown = false)
{
    ...
    $sponsor = \common\models\User::findOne($user['parent_id']);
    ...
    $modalBodyHtml =
        ...
        '<p class="text__small" style="margin-bottom: 0"> Спонсор: <b>'.$sponsor['username'].'</b></p>'.
        ...
        <div id="mySidenav" class="sidenav">
            ...
            <div class="p-5">
                ...
                <div class="form-group">
                    ...
                    <?}else{?>
                        <a href="#" data-toggle="modal" data-target="#confirmModal" style="font-size: 1rem!important;" type="submit" class="btn btn-success  ml-0">Купить место CV <?=$price?> </a>
                    <?}?>
                    ...
                    <div class="form-search d-flex mt-5 flex-wrap">
                        ...
                        <div class="form-group col-6 pl-0">
                            ...
                            <?}else{
                                ...
                                if(!empty($lastmat)){?>
                                    <a href="#" data-toggle="modal" data-target="#confirmModal" type="submit" class="btn btn-success  ml-0">Купить место CV <?=$price?> </a>
                                                ...
                                                <div class="item">
                                                    <div class="icon empty-mat">
                                                        <?if($vacant==1){?>
                                                            ...
                                                            if(!empty($lastmat)){?>
                                                                <a style="height: 130px;width: 130px; border-radius: 10%; display: flex; align-items: center; background: #33B673" href="#" data-toggle="modal" data-target="#confirmModal" type="submit" class="btn btn-success  ml-0"><?if(!empty($canp)){echo "Активировать место";}else{echo "Купить место CV $price";}?></a>
                                                        ...
                                                        <?}else{?>
                                                            <div class="icon empty-mat" >
                                                                <?if($vacant == "s-1"){?>
                                                                    ...
                                                                    if(!empty($lastmat)){?>
                                                                        <a style="height: 130px;width: 130px; border-radius: 10%; display: flex; align-items: center; background: #33B673" href="#" data-toggle="modal" data-target="#confirmModal" type="submit" class="btn btn-success  ml-0"><?if(!empty($canp)){echo "Активировать место";}else{echo "CV ". $price . "\nкупить";}?></a>
                                                            ...
                                                            <?}else{?>
                                                                <div class="icon empty-mat" >
                                                                    <?if($vacant == "s-1_1"){?>
                                                                        ...
                                                                        if(!empty($lastmat)){?>
                                                                            <a style="height: 97px;width: 130px;padding-top: 22px;" href="#" data-toggle="modal" data-target="#confirmModal" type="submit" class="btn btn-success  ml-0"><?if(!empty($canp)){echo "Активировать место";}else{echo "Купить место CV $price ";}?></a>
                                                                ...
                                                                <?}else{?>
                                                                    <div class="icon empty-mat" >
                                                                        <?if($vacant == "s-2_1"){?>
                                                                            ...
                                                                            if(!empty($lastmat)){?>
                                                                                <a style="height: 97px;width: 130px;padding-top: 22px;" href="#" type="submit" data-toggle="modal" data-target="#confirmModal" class="btn btn-success  ml-0"><?if(!empty($canp)){echo "Активировать место";}else{echo "Купить место CV $price ";}?></a>
                                                                            <?}
                                                                            ?>
                                                                            <?}else{?>
                                                                            <a href="#" class="user stretched-link" ></a>
        ...
        <div class="modal-dialog ">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <p>Стоимость места: <?=MLevelsNew::findOne($m)['price']?> CV</p>
<!--                    <p>Комиссия в токенах: --><?//=\common\models\TokenFees::findOne(['platform_id'=>$m])['fee_token']?><!-- GRC</p>-->
                    <p>Ваш баланс: <?=$user['w_balans']?> CV <a href="/profile/perfect" class="btn btn-link" target="_blank">Пополнить</a></p>
<!--                    <p>Ваши токены: --><?//=$tokens?><!-- GRC <a href="/tokens/get" class="btn btn-link" target="_blank">Пополнить</a></p>-->
                    <p>
                        <a href="/profile/getnewplatform?platform=<?=$m?>" class="btn btn-success buyMatrix">Да </a>
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            <div class="modal-body">
                <p>Вы уверены что хотите выкупить/активировать место?</p>
                <p>
                    <a href="/profile/getnewplatform?platform=<?=$m+1?>" class="btn btn-success buyMatrix">Да </a>
                    <button class="btn btn-danger" data-dismiss="modal">Нет </button>
                </p>
