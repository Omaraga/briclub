...
<!--        <div class="row">-->
<!--            <div class="col-sm-6">-->
<!--                <div class="modal_container mt-5 mb-5">-->
<!--                    <h3>--><?//=$this->title?><!--</h3>-->
<!--                    --><?//
//                        if(empty($ver) || $ver['status'] == 0){?>
<!--                            --><?php //$form = \yii\widgets\ActiveForm::begin(['id' => 'form-verification','options' => ['enctype' => 'multipart/form-data']]); ?>
<!--                            <div class="form-group">-->
<!--                                --><?// echo $form->field($verificationForm, 'file1')->fileInput(['class'=>'form-control-file btn btn-link pl-0']);  ?>
<!--                                --><?// echo $form->field($verificationForm, 'file2')->fileInput(['class'=>'form-control-file btn btn-link pl-0']);  ?>
<!--                                --><?// echo $form->field($verificationForm, 'file3')->fileInput(['class'=>'form-control-file btn btn-link pl-0']);  ?>
<!--                                --><?// echo $form->field($verificationForm, 'address')->textInput(['class'=>'form-control pl-0']);  ?>
<!--                            </div>-->
<!--                            <input class="btn-success btn" type="submit" value="--><?//=Yii::t('users', 'SAVE')?><!--">-->
<!--                            --><?php //\yii\widgets\ActiveForm::end(); ?>
<!--                        --><?//}elseif ($ver['status'] == 1){?>
<!--                            <p>Ваши данные проверяются модератором. </p>-->
<!--                        --><?//}elseif ($ver['status'] == 2){?>
<!--                            <p>Ваш аккаунт не был верифицирован, пожалуйста загрузите документы повторно.</p>-->
<!--                            <p>--><?//=$ver['comment']?><!--</p>-->
<!--                            --><?php //$form = \yii\widgets\ActiveForm::begin(['id' => 'form-verification','options' => ['enctype' => 'multipart/form-data']]); ?>
<!--                            <div class="form-group">-->
<!--                                --><?// if($ver['doc1_status'] == 1){
//                                    echo $form->field($verificationForm, 'file1')->fileInput(['class'=>'form-control-file btn btn-link pl-0']);
//                                }?>
<!--                                --><?// if($ver['doc2_status'] == 1){ echo $form->field($verificationForm, 'file2')->fileInput(['class'=>'form-control-file btn btn-link pl-0']);}  ?>
<!--                                --><?// if($ver['doc3_status'] == 1){ echo $form->field($verificationForm, 'file3')->fileInput(['class'=>'form-control-file btn btn-link pl-0']); } ?>
<!--                                --><?// if($ver['doc4_status'] == 1){echo $form->field($verificationForm, 'address')->textInput(['class'=>'form-control pl-0']); } ?>
<!--                            </div>-->
<!--                            <input class="btn-success btn" type="submit" value="--><?//=Yii::t('users', 'SAVE')?><!--">-->
<!--                            --><?php //\yii\widgets\ActiveForm::end(); ?>
<!--                        --><?//}elseif ($ver['status'] == 3){?>
        ...
        <div class="row mt-5">
            ...
            <div class="col-lg-9 col-sm-8 col-12">
                <div class="box__right">
                    <div class="row">
                        <div id="block__userSettings" class="col-lg-5 col-12">
                            <p class="text__middle w5 mb-5 col--12">Настройки</p>
                            <div class="info__block">
                                <div class="d-flex">
                                    <div class="text__group">
                                        <p class="w5">Информация профиля</p>
                                        <?if($model->stage == Verifications::STAGE_ALL_VALIDATED):?>
                                            <p class="text__mini">Аккаунт прошел полную верификацию</p>
                                        <?else:?>
                                ...
                                <a class="tabs__link hide_button btn__white btn" href="/profile/verification" style="display: block">Верификация</a>
                            </div>
                            <div class="">
                                <ul class="nav nav-tabs tabs__list mt-4" id="myTab" role="tablist">

                                    <li class="nav-item tabs__item" role="presentation">
                                        <a class="nav-link tabs__link" id="home-tab" href="/profile/settings/personal">
                                    ...
                                    <li class="nav-item tabs__item" role="presentation">
                                        <a class="nav-link tabs__link" id="home-tab" href="/profile/settings/safety">
                        ...
                        <div class="col-lg-7 col-md-12 d-lg-block">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane <?=($model->stage == 0)?'active':'';?>" id="two" role="tabpanel" aria-labelledby="home-tab">
                                    <div class="">
                                        <div class="box__settings-verefik fon">
                                            <div class="row">
                                                <h2 class="h2 w5 mb-5 text-white">Верификация вашей электронной почты</h2>
                                                <p class="">Привет <?=$user['firstname']?>, подтвердите свою электронну почту для пользование сервисом без ограничение</p>
                                                <div class="col-12 ">
                                                    <? $formEmail = \yii\widgets\ActiveForm::begin(['id' => 'form-email-send']); ?>
                                                        ...
                                                        <button class="btn btn__blue" type="submit" >Подтвердить почту</button>
                                    ...
                                    <div class="">
                                        <div class="box__settings fon text-center">
                                            <div class="">
                                                ...
                                                <p class="col-12 mt-5" style="color: #B3C4E5;">Введите код отправленный на электронную почту</p>
                                                ...
                                                <div class="right__box-inputs col-12 px-2">
                                                    ...
                                                    <input class="input" type="text" maxlength="1" oninput="this.value=this.value.replace(/[^0-9]/g,'');" />
                                                    <input class="input" type="text" maxlength="1" oninput="this.value=this.value.replace(/[^0-9]/g,'');" />
                                                    <input class="input" type="text" maxlength="1" oninput="this.value=this.value.replace(/[^0-9]/g,'');" />
                                                    <input class="input" type="text" maxlength="1" oninput="this.value=this.value.replace(/[^0-9]/g,'');" />
                                                    <input class="input" type="text" maxlength="1" oninput="this.value=this.value.replace(/[^0-9]/g,'');" />
                                                ...
                                                <input type="button" value="Отправить повторно?"  class="mt-3" id="sendEven" name="sendEven" style="display: none; background-color: Transparent;background-repeat:no-repeat;border: none;cursor:pointer;overflow: hidden;color:#ffffff;" disabled/>

                                                <button class="btn btn-primary col-9 mt-5" type="submit">Подтвердить почту</button>
                                                <? \yii\widgets\ActiveForm::end(); ?>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="block__fon-gray my-5 p-4">
                                                        ...
                                                        <?if ($model->stage == Verifications::STAGE_MODIFY_USER_DATA):?>
                                                            <p class="text__small">Адинистратор: <?=(isset($model->comment) && strlen($model->comment) > 0)?$model->comment:'верификация не пройдена загрузите документы повторно';?></p>
                                                            <button class="btn__small btn__blue " id="verifyMainData">Верифицировать повторно</button>
                                                        <?else:?>
                                                            <p class="text__small">Подтвердите вашу личность пройдя второй уровень верификации основных данных
                                                            </p>
                                                            <button class="btn btn__small btn__blue " id="verifyMainData">Начать</button>
                                                        <?endif;?>

                                                    </div>
                                                    <div class="block__fon-gray p-4">
                                                        <p class="w5">Верификация адресных данных</p>
                                                        <p class="text__small">Третий уровень верификации будет доступен после подтверждения основных данных личности.</p>

                                                        <button class="btn btn__small btn__blue " id="verifyAddress" disabled>Начать</button>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="tab-verif" id="mainDataTab1">
                                                        ...
                                                        <div class="mt-4">
                                                            ...
                                                            <div class="fild__name-group mt-2">
                                                                <?if($model->stage == Verifications::STAGE_MODIFY_USER_DATA && $model->doc1_status == 1):?>
                                                                    <p>Передняя сторона документа валидирована,и не требует повторной загрузки</p>
                                                                <?else:?>
                                                                    <div class="file-input-block" id="input-file1">
                                                                        ...
                                                                        <button class="btn btn__blue btn__small open-input-file" data-file="file1">Выбрать файл</button>
                                                        ...
                                                        <div class="mt-3">
                                                            ...
                                                            <div class="fild__name-group mt-2">
                                                                <?if($model->stage == Verifications::STAGE_MODIFY_USER_DATA && $model->doc2_status == 1):?>
                                                                    <p>Задняя сторона документа валидирована,и не требует повторной загрузки</p>
                                                                <?else:?>
                                                                    <div class="file-input-block" id="input-file2">
                                                                        ...
                                                                        <button class="btn btn__blue btn__small open-input-file" data-file="file2">Выбрать файл</button>
                                                        ...
                                                        <div class="mt-4 text-end">
                                                            <button class="btn__small btn__blue " id="mainDataNext">Далее</button>
                                                        </div>
                                                    </div>
                                                    <div class="tab-verif" id="mainDataTab2" style="display: none">
                                                        ...
                                                        <p class="text__small mt-4">
                                                            Загрузите фотографию, где изображены Вы с паспортом. Убедитесь что изображение вашего лица четкое, а все паспортные данные можно легко прочитать.
                                                        </p>
                                                        <p class="text__small">
                                                        ...
                                                        <div class="fild__name-group mt-2">
                                                            ...
                                                            <?else:?>
                                                                <div class="file-input-block" id="input-file3">
                                                                    ...
                                                                    <button class="btn btn__blue btn__small open-input-file" data-file="file3">Выбрать файл</button>
                                                        ...
                                                        <div class="mt-4 text-end">
                                                            <button class="btn btn__small btn__white" id="mainDataVerification-2-back">Назад</button>
                                                            <button class="btn btn__small btn__blue" type="submit" id="inputFileSave">Далее</button>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="">
                                                <div class="box__settings fon">
                                                    <div class="row">
                                                        ...
                                                        <div class="block__fon-gray my-5 p-4">
                                                            <p class="w5">Верификация основных данных</p>
                                                            <p class="text__small">Ваши документы находятся на рассмотрении. Максимальное время обработки заявки займет 5 рабочих дней. Результат вы получите по почте.
                                                            </p>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="block__fon-gray p-4">
                                                        <?if ($model->stage == Verifications::STAGE_ADDRESS_MODIFY):?>
                                                            <p class="w5">Верификация адресных данных</p>
                                                            <p class="text__small">Адинистратор: <?=(isset($model->comment) && strlen($model->comment) > 0)?$model->comment:'верификация не пройдена загрузите документы повторно';?></p>
                                                            <button class="btn__small btn__blue" id="startVerifAddress">Верифицировать повторно</button>
                                                        <?else:?>
                                                            <p class="w5">Верификация адресных данных</p>
                                                            <p class="text__small">Подтвердите ваши адресные данные пройдя третий уровень верификации</p>
                                                            <button class="btn__small btn__blue" id="startVerifAddress">Начать</button>
                                                        <?endif;?>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <?php $form = \yii\widgets\ActiveForm::begin(['id' => 'form-verification','options' => ['enctype' => 'multipart/form-data']]); ?>
                                                        ...
                                                        <div class="verif-address-tab" id="addressVerifTab2" style="display:none;">
                                                            <p class="w5 text__middle">Верификация адресных данных</p>
                                                            <p class="text__small">Пожалуйста, загрузите один из следующих документов:</p>

                                                            <div class="">
                                                                <ul>
                                                                    <li>
                                                                        <p class="text__small">
                                                                            счет за оплату комунальных услуг (электроэнергия, газ, вода, отопление и т.п). К рассмотрению принимаются справки не позднее 3х месяцев от начала его получение.
                                                                        </p>
                                                                    </li>
                                                                    <li>
                                                                        <p class="text__small">
                                                                            справка из банка, где указан адрес вашего проживание. К рассмотрению принимаются справки не старше 3х месяцев от начала его получение.
                                                                        </p>
                                                                    </li>
                                                                    <li>
                                                                        <p class="text__small">
                                                                            документ от государственных органов (налоговая, пенсионный фонд и т.п). Принимается наиболее свежий вариант.
                                                                        </p>
                                                                    </li>
                                                                    <li>
                                                                        <p class="text__small">
                                                                            любой другой документ государственного образца где указаны полнык ФИО и адрес.
                                                                        </p>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                                ...
                                                                <div class="file-upload">
                                                                    ...
                                                                    <?else:?>
                                                                        <div class="file-input-block" id="input-file4">
                                                                            ...
                                                                            <button class="btn btn__blue btn__small open-input-file" data-file="file4">Выбрать файл</button>
                                                            ...
                                                            <div class="mt-4 text-end">
                                                                <button class="btn btn__small btn__white" id="addressBack">Назад</button>
                                        ...
                                        <div class="">
                                            <div class="box__settings fon">
                                                <div class="row">
                                                    ...
                                                    <div class="block__fon-gray my-5 p-4">
                                                        <p class="w5">Верификация основных данных</p>
                                                        <p class="text__small">Вы успешно прошли второй уровень верификации. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
                                                        <div class="info__line-green">
                                                            <img src="/img/galka.svg" alt="">
                                                            <span class="text__small ml-2 text-dark w5">Основные документы верифицированы</span>
                                                        </div>
                                        ...
                                        <div class="">
                                            <div class="box__settings fon">
                                                <div class="row">
                                                    ...
                                                    <div class="block__fon-gray p-4">
                                                        <p class="w5">Верификация адресных данных</p>
                                                        <p class="text__small">Вы успешно прошли третий уровень верификации. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
                                                        <div class="info__line-green">
                                                            <img src="/img/galka.svg" alt="">
                                                            <span class="text__small ml-2 text-dark w5">Данные верифицированы</span>
                                                        </div>
