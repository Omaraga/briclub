                ...
                <div class="col-lg-12">
                    ...
                    <div class="col-lg-9 mt-4">
                        <div class="block__fon">
                            ...
                            <div class="">
                                <span class="h2 w7 text-white">US</span>
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Advcash</a>
                            </li>
                        </ul>
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                <h2 class="h2 mb-0">Advcash</h2>
                                <p>Комиссия: 3%</p>
                                <?
                                if(!empty($error)){?>
