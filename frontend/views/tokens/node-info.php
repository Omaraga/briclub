    ...
    <main class="home">
        <div class="container">
            <div class="hgroup pt-3">
                ...
                <h5 class="h5"> Компания “Best Road Investment” разрабатывает собвстенную блокчейн экосистему, которая дает использовать пользователям мультифункциональной платформы безграничные возможности цифрового мира и вводит токенизацию.
